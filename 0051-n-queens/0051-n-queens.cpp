...
public:
    ...
    vector<vector<string>> solveNQueens(int n) {    
     ...
     // for implementing the solve function, we just ahve to check the row for the previous elements, then we have to check for the diagonals, we dont have to look for the next diagonal as the queen hasn't been placed yet so we have three conditions to check for.
